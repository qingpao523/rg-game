...
const WEAPONS = {
  taoist: [
    { id: 'w_t1', name: '桃木剑', rarity: '普通', shards: 10, icon: 'icons/thunder_seal.png',
      desc: '魔法飞弹命中后分裂 1 枚小飞弹（50% 伤害）', effect: { type: 'missile_split', value: 1 } },
    { id: 'w_t2', name: '五雷令牌', rarity: '稀有', shards: 25, icon: 'icons/thunder_bolt.png',
      desc: '天雷击命中后地面留电弧 2s（30% 伤害/s）', effect: { type: 'bolt_zone', value: 2 } },
    { id: 'w_t3', name: '诛仙剑', rarity: '史诗', shards: 50, icon: 'icons/thunder_net.png',
      desc: '弹射闪电弹射次数 +2', effect: { type: 'chain_plus', value: 2 } },
  ],
  samurai: [
    { id: 'w_s1', name: '无名刀', rarity: '普通', shards: 10, icon: 'icons/flash_slash.png',
      desc: '一闪路径上留下残影剑气（40% 伤害）', effect: { type: 'slash_after', value: 0.4 } },
    { id: 'w_s2', name: '村正妖刀', rarity: '稀有', shards: 25, icon: 'icons/doom_star.png',
      desc: '击杀后 3s 内下次一闪伤害 +50%', effect: { type: 'kill_amp', value: 0.5 } },
    { id: 'w_s3', name: '天丛云剑', rarity: '史诗', shards: 50, icon: 'icons/meteor.png',
      desc: '一闪范围扩大 50%，路径上敌人全部冻结 0.5s', effect: { type: 'slash_wide', value: 0.5 } },
  ],
  pharaoh: [
    { id: 'w_p1', name: '枯骨杖', rarity: '普通', shards: 10, icon: 'icons/summon_skeleton.png',
      desc: '骷髅上限 +1', effect: { type: 'summon_cap', value: 1 } },
    { id: 'w_p2', name: '阿努比斯权杖', rarity: '稀有', shards: 25, icon: 'icons/skeleton_archer.png',
      desc: '骷髅射手额外发射 1 支骨箭', effect: { type: 'archer_multi', value: 1 } },
    { id: 'w_p3', name: '图坦卡蒙面具', rarity: '史诗', shards: 50, icon: 'icons/white_bone_army.png',
      desc: '亡者复苏概率 +15%，复活血量 +50%', effect: { type: 'raise_boost', value: 0.15 } },
  ],
  ice_witch: [
    { id: 'w_i1', name: '冰晶法杖', rarity: '普通', shards: 10, icon: 'icons/ice_shard.png',
      desc: '冰锥碎片命中后 20% 概率冻结 0.5s', effect: { type: 'ice_freeze', value: 0.2 } },
    { id: 'w_i2', name: '霜之哀伤', rarity: '稀有', shards: 25, icon: 'icons/frozen_field.png',
      desc: '极寒领域半径 +20%', effect: { type: 'field_range', value: 0.2 } },
    { id: 'w_i3', name: '永冬王冠', rarity: '史诗', shards: 50, icon: 'icons/ice_thorn_storm.png',
      desc: '被冰冻敌人死亡时碎裂（周围 30% 伤害）', effect: { type: 'freeze_shatter', value: 0.3 } },
  ],
  crusader: [
    { id: 'w_c1', name: '铁壁盾', rarity: '普通', shards: 10, icon: 'icons/holy_shield.png',
      desc: '护盾上限 +20', effect: { type: 'shield_hp', value: 20 } },
    { id: 'w_c2', name: '圣光战锤', rarity: '稀有', shards: 25, icon: 'icons/holy_guardian.png',
      desc: '圣盾冲阵结束时击退范围 +30%', effect: { type: 'charge_knock', value: 0.3 } },
    { id: 'w_c3', name: '光明使者', rarity: '史诗', shards: 50, icon: 'icons/holy_obelisk.png',
      desc: '护盾存在期间每秒回复 2 生命', effect: { type: 'shield_regen', value: 2 } },
  ],
};
